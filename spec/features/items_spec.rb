...
RSpec.feature "Feature: create, update, show and destroy items" do
	...
	scenario "Scenario: allow a user to update the description and name of an item" do
		...
		fill_in "item_description", with: "new desciption"

		find(:xpath,"//input[@name='commit']").click

		expect(page).to have_content("Item was successfully updated. Name: new name Description: new desciption Edit | Back")
	end

	scenario "Scenario: allow a user to delete an item" do 
		visit('/')
